            ...
            <div class="col-md-12 d-flex align-items-stretch grid-margin">
              <div class="row flex-grow">
                <div class="col-12">
                  <div class="card">
                    <div class="card-body">
                      <h4 class="card-title">Edit User <b>{{$data->name}}</b> </h4>
                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            <label for="deskripsi" class="col-md-4 control-label">Name</label>
                            <div class="col-md-12">
                        ...
                        <div class="form-group{{ $errors->has('bio') ? ' has-error' : '' }}">
                            <label for="deskripsi" class="col-md-4 control-label">Bio</label>
                            <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                <input id="password" type="hidden" class="form-control" name="password" value="{{ $data->password }}" >
                            </div>
                        ...
                        <div class="col-md-12 form-group">
                            <label for="level" class="col-md-4 control-label">Image</label>
                            <div class="col-md-12">
